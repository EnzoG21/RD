...
@section('content')
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 my-8 text-white"> 
        ...
        <form action="{{ route('committee.panel.order.update') }}" method="POST">
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md mb-8">Update Status</button>
        </form>
    </div>
@endsection
